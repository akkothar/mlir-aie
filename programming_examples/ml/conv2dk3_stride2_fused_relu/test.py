...
InC_vec =  math.floor(tensorL2InC/3)
OutC_vec =  math.floor(tensorL2OutC/vectorSize)
...
def main(opts):
    ...
    shape_total_wts = (3*3*tensorL2InC*tensorL2OutC, 1)
    shape_in_act = (tensorInH, InC_vec, tensorInW, 8)  #'YCXC8' , 'CYX'
    ...
    quant_bottleneck_model = QuantConv2d3x3(in_planes=tensorL2InC,planes=tensorL2OutC)
