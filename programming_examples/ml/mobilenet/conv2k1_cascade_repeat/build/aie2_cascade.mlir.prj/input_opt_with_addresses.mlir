module attributes {llvm.target_triple = "aie2"} {
  ...
  llvm.func @conv2dk1_skip_ui8_i8_put(!llvm.ptr, !llvm.ptr, i32, i32, i32) attributes {sym_visibility = "private"}
  ...
  ^bb4:  // pred: ^bb3
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%24, %20, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%28, %20, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
  ...
  ^bb5:  // pred: ^bb3
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%37, %33, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
  ...
  ^bb7:  // pred: ^bb6
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%43, %33, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%7, %13) : (i32, i32) -> ()
    "llvm.intr.assume"(%36) : (i1) -> ()
    "llvm.intr.assume"(%40) : (i1) -> ()
  ...
  ^bb8:  // pred: ^bb6
    ...
    "llvm.intr.assume"(%51) : (i1) -> ()
    llvm.call @conv2dk1_skip_ui8_i8_put(%48, %33, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%5, %9) : (i32, i32) -> ()
  ...
  ^bb11:  // pred: ^bb10
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%59, %55, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%7, %13) : (i32, i32) -> ()
    "llvm.intr.assume"(%58) : (i1) -> ()
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%63, %55, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
  ...
  ^bb12:  // pred: ^bb10
    ...
    llvm.call @conv2dk1_skip_ui8_i8_put(%72, %68, %11, %10, %10) : (!llvm.ptr, !llvm.ptr, i32, i32, i32) -> ()
    llvm.call @llvm.aie2.release(%6, %9) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%5, %9) : (i32, i32) -> ()
    llvm.return
  }
