...
bneck_13_OutC3 = 64
OutputSplit_2=bneck_13_OutC3//8 #calculate 8 OCs at a time, should bneck_13_InC1rease to more
if len(sys.argv) == 3:
...
# HERE
            ...
            cascade_flow(ComputeTile13, ComputeTile03)
            ...
            def sequence(inputFromL3, weightsFromL3, outputToL3):
                ...
                NpuWriteRTPOp("rtp13", col=1, row=3, index=0, value=10)
