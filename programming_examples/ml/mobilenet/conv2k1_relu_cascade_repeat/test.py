...
def main(opts):
    ...
    int_weight_3_put1=int_weight_3[:,0:64,:,:]
    int_weight_3_put2=int_weight_3[:,64:128,:,:]
    # int_weight_3_get1=int_weight_3[:,128:192,:,:]
    # int_weight_3_get2=int_weight_3[:,192:256,:,:]
    ...
    wts3_put1 = ds.reorder_mat(
        int_weight_3_put1.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    )
    wts3_put2 = ds.reorder_mat(
        int_weight_3_put2.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    )
    
    # wts3_get1 = ds.reorder_mat(
    #     int_weight_3_get1.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    # )

    # wts3_get2 = ds.reorder_mat(
    #     int_weight_3_get2.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    # )

    # wts3_put_HALF = ds.reorder_mat(
    #     int_weight_3_HALF.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    # )
    total_wts = np.concatenate((wts3_put1,wts3_put2), axis=None)
