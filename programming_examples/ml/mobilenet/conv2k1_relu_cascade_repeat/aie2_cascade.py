...
# HERE
            ...
            object_fifo_link(OF_wts_L3L2, [OF_wts_memtile_put,OF_wts_memtile_get],[],[0,InC//WeightSplit * OutC])
            OF_wts_memtile_put.set_memtile_repeat(1)
            OF_wts_memtile_get.set_memtile_repeat(1)
            ...
            def core_body():
                ...
                for _ in for_(0xFFFFFFFF):
                    ...
                    for _ in for_(InH2):
                        ...
                        for weight_index in for_(WeightSplitPerCore):
