...
8:                                                ; preds = %5
  ...
  call void @conv2dk1_ui8_put(ptr @inOF_act_L3L2_0_cons_buff_0, ptr @OF_wts_memtile_put_cons_buff_0, i32 7, i32 64, i32 64)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.assume(i1 %10)
  ...
  %14 = icmp eq i64 %13, 0
  call void @llvm.assume(i1 %14)
  call void @conv2dk1_ui8_put(ptr @inOF_act_L3L2_0_cons_buff_1, ptr @OF_wts_memtile_put_cons_buff_0, i32 7, i32 64, i32 64)
  call void @llvm.aie2.release(i32 48, i32 1)
  %15 = add i64 %6, 2
  br label %5
...
declare void @conv2dk1_ui8_put(ptr, ptr, i32, i32, i32)
