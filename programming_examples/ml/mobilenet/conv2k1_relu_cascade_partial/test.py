...
def main(opts):
    ...
    int_weight_get=int_weight[:,OutC2//2:OutC2,:,:]

    wts3_put= ds.reorder_mat(
        int_weight_put.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    )
    wts3_get= ds.reorder_mat(
        int_weight_get.data.numpy().astype(dtype_wts), "OIYXI8O8", "OIYX"
    )
