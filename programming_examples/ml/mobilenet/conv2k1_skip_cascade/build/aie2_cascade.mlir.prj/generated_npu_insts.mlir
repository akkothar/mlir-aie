module {
  aie.device(npu1_1col) {
    ...
    ^bb4:  // pred: ^bb3
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_0, %OF_wts_memtile_put_cons_buff_0, %c7_i32, %c64_i32, %c64_i32_3) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_1, %OF_wts_memtile_put_cons_buff_0, %c7_i32_4, %c64_i32_5, %c64_i32_6) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
    ...
    ^bb5:  // pred: ^bb3
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_0, %OF_wts_memtile_put_cons_buff_0, %c7_i32_7, %c64_i32_8, %c64_i32_9) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
    ...
    ^bb7:  // pred: ^bb6
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_1, %OF_wts_memtile_put_cons_buff_0, %c7_i32_15, %c64_i32_16, %c64_i32_17) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
      aie.use_lock(%inOF_act_L3L2_0_cons_cons_lock, AcquireGreaterEqual, 1)
      %c7_i32_18 = arith.constant 7 : i32
      %c64_i32_19 = arith.constant 64 : i32
      %c64_i32_20 = arith.constant 64 : i32
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_0, %OF_wts_memtile_put_cons_buff_0, %c7_i32_18, %c64_i32_19, %c64_i32_20) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
    ...
    ^bb8:  // pred: ^bb6
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_1, %OF_wts_memtile_put_cons_buff_0, %c7_i32_21, %c64_i32_22, %c64_i32_23) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
      aie.use_lock(%OF_wts_memtile_put_cons_prod_lock, Release, 1)
    ...
    ^bb11:  // pred: ^bb10
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_0, %OF_wts_memtile_put_cons_buff_0, %c7_i32_29, %c64_i32_30, %c64_i32_31) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
      aie.use_lock(%inOF_act_L3L2_0_cons_cons_lock, AcquireGreaterEqual, 1)
      %c7_i32_32 = arith.constant 7 : i32
      %c64_i32_33 = arith.constant 64 : i32
      %c64_i32_34 = arith.constant 64 : i32
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_1, %OF_wts_memtile_put_cons_buff_0, %c7_i32_32, %c64_i32_33, %c64_i32_34) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
    ...
    ^bb12:  // pred: ^bb10
      ...
      func.call @conv2dk1_ui8_put(%inOF_act_L3L2_0_cons_buff_0, %OF_wts_memtile_put_cons_buff_0, %c7_i32_35, %c64_i32_36, %c64_i32_37) : (memref<7x1x64xui8>, memref<2048xi8>, i32, i32, i32) -> ()
      aie.use_lock(%inOF_act_L3L2_0_cons_prod_lock, Release, 1)
      aie.use_lock(%OF_wts_memtile_put_cons_prod_lock, Release, 1)
      aie.end
