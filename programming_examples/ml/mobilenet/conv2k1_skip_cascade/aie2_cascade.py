...
# HERE
            ...
            #     ],
            # )
            bn13_conv2dk1_skip_get = external_func(
            ...
            bn13_conv2dk1_skip_put = external_func(
            ...
            #     "OF_bneck_13_skip", MemTile01, ComputeTile05, 2, ty_bneck_13_layer3_in
            # )
            ...
            OF_bneck_13_layer3_bn_12_layer1 = object_fifo("OF_bneck_13_layer3_bn_12_layer1", ComputeTile05, [MemTile01], 2, ty_bneck_13_layer3_out)
        ...
        # ************************ bneck13 ************************
            ...
            # Compute tile 4
            @core(ComputeTile04, "bn13_conv2dk1_skip_put.o")
            def core_body():
            ...
            # Compute tile 4
            @core(ComputeTile05, "bn13_conv2dk1_skip_get.o")
            def core_body():
                    ...
                    for _ in for_(bneck_13_InH3):
                        ...
                        call(
                            ...
                            [
                                ...
                                elemIn,
                                bneck_13_InW3,
                                bneck_13_OutC2//2, #input_channels
                                bneck_13_OutC3,
                                scale,
                                skipScale,
                            ],
            ...
            activationsInSize32b = (bneck_13_InW1 * bneck_13_InH1 * bneck_13_OutC2) // 4
