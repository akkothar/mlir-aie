...
# 
    ...
    tensorOutW = tensorL2_3InW
    tensorOutH = tensorL2_3InH
    tensorOutC = tensorL2_3OutC
    ...
    def device_body():
        ...
        # act_in = object_fifo("act_in", ShimTile00, ComputeTile04, [3,3], bn1_tensorLayer1_3Out_ty)
        # between compute tiles
