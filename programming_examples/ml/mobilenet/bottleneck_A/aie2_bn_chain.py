...
# 
    ...
    def device_body():
        ...
        # Output
        act_out = object_fifo("act_out", ComputeTile22, ShimTile10, 2, tensorLayerOut_ty)
        ...
        bottleneckACore("bn8", ComputeTile22, act_bn7_bn8, bn8_wts_OF_L3L1, act_out, rtpComputeTile22, bn8_objectArchiveName, 
