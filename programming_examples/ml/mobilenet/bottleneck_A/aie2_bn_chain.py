...
def mobilenetV3_bn_5_6_7_8(tileColIndex = 0,tensorInW = 28, tensorInH = 28, tensorInC = 40, 
                    ...
                    #    bn4_depthWiseStride = 2, bn4_depthWiseChannels = 240, bn4_withSkip = False, bn4_tensorOutC = 80, bn4_scaleFactor1 = 8, bn4_scaleFactor2 = 8, bn4_scaleFactor3 = 11,  bn4_scaleFactorAdd = 0,
    ...
    tensorL5_1InC = tensorInC
    tensorL5_1InW = tensorInW
    tensorL5_1InH = tensorInH
...
# 
    ...
    def device_body():
        ...
        memtile_01_wts=bn5_weights_size
        ...
        ComputeTile02 = tile(tileColIndex, 2)
        ...
        # Input
        act_in = object_fifo("act_in", ShimTile00, ComputeTile02, 2, tensorLayerIn_ty)

        # wts
        wts_OF_01_L3L2 = object_fifo("wts_OF_01_L3L2", ShimTile00, MemTile01, 1, memtile_01_wts_ty)
        bn5_wts_OF_L3L1 = object_fifo("bn5_wts_OF_L2L1", MemTile01, ComputeTile02, [1,1], memtile_01_wts_ty)
        object_fifo_link(wts_OF_01_L3L2, [bn5_wts_OF_L3L1],[],[0])


       

        # between compute tiles
        act_bn5_bn6 = object_fifo("act_bn5_bn6", ComputeTile02, ComputeTile12, 2, bn5_tensorLayer3Out_ty)
        
        
                
        # Set up compute tiles
        rtpComputeTile02 = Buffer(ComputeTile02, [16], T.i32(), "rtp02")
        ...
        bottleneckACore("bn5", ComputeTile02, act_in, bn5_wts_OF_L3L1, act_bn5_bn6, rtpComputeTile02, bn5_objectArchiveName,
        ...
        memtile_01_wts32b=(bn5_weights_size)//4
        memtile_11_wts32b=(bn6_weights_size+bn7_weights_size+bn8_weights_size)//4

        @FuncOp.from_py_func(activationsInL3_ty, weightsInL3_ty, activationsOutL3_ty)
        def sequence(inputFromL3, weightsFromL3, outputToL3):
            NpuWriteRTPOp("rtp02", col=tileColIndex, row=2, index=0, value=bn5_scaleFactor1)
            NpuWriteRTPOp("rtp02", col=tileColIndex, row=2, index=1, value=bn5_scaleFactor2)
            NpuWriteRTPOp("rtp02", col=tileColIndex, row=2, index=2, value=bn5_scaleFactor3)
            NpuWriteRTPOp("rtp02", col=tileColIndex, row=2, index=3, value=bn5_scaleFactorAdd)
...
with mlir_mod_ctx() as ctx:
    mobilenetV3_bn_5_6_7_8(tileColIndex = 0, tensorInW = 28, tensorInH = 28, tensorInC = 40, 
